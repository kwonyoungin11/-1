...
| D | `.worktrees/pw05-phase6` | `feature/pw05-phase6` | `docs/LIVE_READINESS_CHECKLIST.md`, `docs/plans/LIVE_READINESS_EVIDENCE.md`, `docs/plans/MASTER_PLAN.md` | Phase 6 evidence map progress (docs only) — **done 2026-07-09**: honest A–E map, `LIVE_READY=false` fixed, scripts/tests linked; no live claim |
